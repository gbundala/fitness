...
class Live extends Component {
  ...
  //FIXME: run the remove function from the expo docs to unmount the subscription
  // componentWillUnmount() {}

  render() {
    const { coordinates, status, direction, bounceValue } = this.state;
      ...
      <View style={styles.container}>
        ...
        <View style={styles.metricContainer}>
          ...
          <View style={styles.metric}>
            ...
            <Text style={[styles.subHeader, { color: white }]}>
              {(coordinates.speed * 2.2369).toFixed(1)} MPH
            </Text>
          </View>
        </View>
      </View>
